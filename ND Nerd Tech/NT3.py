...
def solve(testCaseSquare: list) -> str:
    first_string = testCaseSquare[0]
    second_string = testCaseSquare[1]
    operation_string = testCaseSquare[2]
...
TESTCASES = [['14;10', '1110;2', '+;10'],
             ['B3;19', '16052;7', '-;12'],
             ['220;14', '1140;7', '/;18'],
             ['-1A.F51BF51BF51BF51BF51C;17', 'HD;25', '*,14']] #inputs / entrées

ANSWERS = [['28;10'],
           ['-2590;12'],
           ['1;18'],
           ['-464C.2B2B2B2B2B2B2B2B2B2B;14']] #expected outputs / sorties attendue
